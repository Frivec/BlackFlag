...
import fr.frivec.api.managers.AbstractManager;
...
public class MenuManager extends AbstractManager {
    ...
    public void onOpenMenu(final Player player, final AbstractMenu menu) {
    	...
    	player.setMetadata("GUI_USE_" + menu.name, new FixedMetadataValue(BlackFlag.getInstance(), true));
    	menu.open(player);
